...
function Nav() {
  ...
  const socialLinks = [
    {
      key: "whatsapp",
      icon: <WhatsAppIcon />,
      link: `https://wa.me/${+923003359414}?text=${encodeURIComponent(
  ...
  return (
    <>
      <div className="container-fluid p-2 bg-dark top-nav fixed-top ">
        <div>
          <span>
            <CallIcon sx={{ color: "yellow" }} fontSize="small" />
            <span className="text-light ms-2">0335-0787287</span>
          </span>
        </div>
        <div className="ms-3">
          <span>
            ...
            <span className="text-light ms-2">tabletalk042@gmail.com</span>
          </span>
        </div>
      </div>

      <div className="container-fluid d-flex justify-content-between p-3 bg-light fixed-top navbar-fixed-top-2 ">
        ...
        <div className="list  display">
          <ul className="d-flex my-auto  list-unstyled">
            {navItem.map((item) => (
              <li className=" px-4 " key={item.key}>
                <Link
